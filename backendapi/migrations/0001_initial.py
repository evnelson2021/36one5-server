# Generated by Django 4.1.7 on 2023-03-14 21:35
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('admin_user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='backendapi.profile')),
                ('favorite', models.ManyToManyField(related_name='favorite_venue', through='backendapi.Favorite', to='backendapi.profile')),
            ],
        ),
        migrations.AddField(
            model_name='favorite',
            name='profile',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='profile_with_favorite', to='backendapi.profile'),
        ),
        migrations.AddField(
            model_name='favorite',
            name='venue',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='favorite_venue', to='backendapi.venue'),
        ),
        migrations.CreateModel(
            name='Event',
            fields=[
